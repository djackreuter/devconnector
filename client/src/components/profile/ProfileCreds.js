    ...
    return (
      <div className="row">
        <div className="col-md-6">
          ...
          {expItems.length > 0 ? (<ul className="list-group">{expItems}</ul>) : <p className="text-center">No experience to show</p>}
        </div>
        <div className="col-md-6">
          <h3 className="text-center text-info">Education</h3>
          {eduItems.length > 0 ? (<ul className="list-group">{eduItems}</ul>) : <p className="text-center">No education to show</p>}
        </div>
      </div>
    )
  }
